...
for i in range(EPOCHS):
    ...
    for step in range(num_train_batches):
        ...
        loss_value, acc, state = train_step_cpu(state, batch_data)
    ...
    for step in range(num_valid_batches):
        ...
        loss_value, acc = test_step_cpu(state, batch_data)
...
ckpt = {'model': state, 'training_loss':training_loss, 'training_accuracy':training_accuracy, 'validation_loss':validation_loss,'validation_accuracy':validation_accuracy}
